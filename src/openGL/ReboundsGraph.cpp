...
void ReboundsGraph::onWindowAttached(screen_window_t handle, const QString& group, const QString& id)
{
...
void ReboundsGraph::onCreationCompleted()
{
    ...
    m_renderer = new ReboundsRenderer(bb::cascades::Application::instance()->mainWindow()->groupId(), "GLgraphThread", preferredWidth(), preferredHeight());
}
