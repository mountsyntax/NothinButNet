...
void TwitterStreamGraph::onWindowAttached(screen_window_t handle, const QString& group, const QString& id)
{
...
void TwitterStreamGraph::onCreationCompleted()
{
    ...
    m_renderer = new TwitterStreamRenderer(bb::cascades::Application::instance()->mainWindow()->groupId(), "GLgraphThread", preferredWidth(), preferredHeight());
